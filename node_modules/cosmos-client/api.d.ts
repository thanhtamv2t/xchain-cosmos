...
export declare const BankApiFp: (configuration?: Configuration | undefined) => {
     ...
     * @throws {RequiredError}
     */
    bankBalancesAddressGet(address: string, options?: any): (axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<Array<Coin>>;
};
/**
...
export declare const BankApiFactory: (configuration?: Configuration | undefined, basePath?: string | undefined, axios?: AxiosInstance | undefined) => {
     ...
     * @throws {RequiredError}
     */
    bankBalancesAddressGet(address: string, options?: any): AxiosPromise<Array<Coin>>;
};
/**
...
export declare const DistributionApiFp: (configuration?: Configuration | undefined) => {
     ...
     * @throws {RequiredError}
     */
    distributionCommunityPoolGet(options?: any): (axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<Array<Coin>>;
    /**
     * Get the sum of all the rewards earned by delegations by a single delegator
     * @summary Get the total rewards balance from all delegations
     * @param {string} delegatorAddr Bech32 AccAddress of Delegator
     ...
     * @throws {RequiredError}
     */
    distributionDelegatorsDelegatorAddrRewardsValidatorAddrGet(delegatorAddr: string, validatorAddr: string, options?: any): (axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<Array<Coin>>;
    /**
     * Withdraw a delegator\'s delegation reward from a single validator
     * @summary Withdraw a delegation reward
     * @param {string} delegatorAddr Bech32 AccAddress of Delegator
     ...
     * @throws {RequiredError}
     */
    distributionValidatorsValidatorAddrOutstandingRewardsGet(validatorAddr: string, options?: any): (axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<Array<Coin>>;
    /**
     * Query the commission and self-delegation rewards of validator.
     * @summary Commission and self-delegation rewards of a single validator
     * @param {string} validatorAddr Bech32 OperatorAddress of validator
     ...
     * @throws {RequiredError}
     */
    distributionValidatorsValidatorAddrRewardsGet(validatorAddr: string, options?: any): (axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<Array<Coin>>;
    /**
     * Withdraw the validator\'s self-delegation and commissions rewards
     * @summary Withdraw the validator\'s rewards
     * @param {string} validatorAddr Bech32 OperatorAddress of validator
...
export declare const DistributionApiFactory: (configuration?: Configuration | undefined, basePath?: string | undefined, axios?: AxiosInstance | undefined) => {
     ...
     * @throws {RequiredError}
     */
    distributionDelegatorsDelegatorAddrRewardsValidatorAddrGet(delegatorAddr: string, validatorAddr: string, options?: any): AxiosPromise<Array<Coin>>;
    /**
     * Withdraw a delegator\'s delegation reward from a single validator
     * @summary Withdraw a delegation reward
     * @param {string} delegatorAddr Bech32 AccAddress of Delegator
     ...
     * @throws {RequiredError}
     */
    distributionValidatorsValidatorAddrOutstandingRewardsGet(validatorAddr: string, options?: any): AxiosPromise<Array<Coin>>;
    /**
     * Query the commission and self-delegation rewards of validator.
     * @summary Commission and self-delegation rewards of a single validator
     * @param {string} validatorAddr Bech32 OperatorAddress of validator
     ...
     * @throws {RequiredError}
     */
    distributionValidatorsValidatorAddrRewardsGet(validatorAddr: string, options?: any): AxiosPromise<Array<Coin>>;
    /**
     * Withdraw the validator\'s self-delegation and commissions rewards
     * @summary Withdraw the validator\'s rewards
     * @param {string} validatorAddr Bech32 OperatorAddress of validator
...
export declare const GovernanceApiFp: (configuration?: Configuration | undefined) => {
     ...
     * @throws {RequiredError}
     */
    govProposalsGet(voter?: string | undefined, depositor?: string | undefined, status?: string | undefined, options?: any): (axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<Array<TextProposal>>;
    /**
     * Generate a parameter change proposal transaction
     * @summary Generate a parameter change proposal transaction
     * @param {PostProposalReq} postProposalBody
     ...
     * @throws {RequiredError}
     */
    govProposalsProposalIdDepositsGet(proposalId: string, options?: any): (axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<Array<Deposit>>;
    /**
     * Send transaction to deposit tokens to a proposal
     * @summary Deposit tokens to a proposal
     * @param {string} proposalId proposal id
     ...
     * @throws {RequiredError}
     */
    govProposalsProposalIdVotesGet(proposalId: string, options?: any): (axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<Array<Vote>>;
    /**
     * Send transaction to vote a proposal
     * @summary Vote a proposal
     * @param {string} proposalId proposal id
...
export declare const GovernanceApiFactory: (configuration?: Configuration | undefined, basePath?: string | undefined, axios?: AxiosInstance | undefined) => {
     ...
     * @throws {RequiredError}
     */
    govProposalsGet(voter?: string | undefined, depositor?: string | undefined, status?: string | undefined, options?: any): AxiosPromise<Array<TextProposal>>;
    /**
     * Generate a parameter change proposal transaction
     * @summary Generate a parameter change proposal transaction
     * @param {PostProposalReq} postProposalBody
     ...
     * @throws {RequiredError}
     */
    govProposalsProposalIdDepositsGet(proposalId: string, options?: any): AxiosPromise<Array<Deposit>>;
    /**
     * Send transaction to deposit tokens to a proposal
     * @summary Deposit tokens to a proposal
     * @param {string} proposalId proposal id
     ...
     * @throws {RequiredError}
     */
    govProposalsProposalIdVotesGet(proposalId: string, options?: any): AxiosPromise<Array<Vote>>;
    /**
     * Send transaction to vote a proposal
     * @summary Vote a proposal
     * @param {string} proposalId proposal id
...
export declare const SlashingApiFp: (configuration?: Configuration | undefined) => {
     ...
     * @throws {RequiredError}
     */
    slashingSigningInfosGet(page: number, limit: number, options?: any): (axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<Array<SigningInfo>>;
    /**
     * Send transaction to unjail a jailed validator
     * @summary Unjail a jailed validator
     * @param {string} validatorAddr Bech32 validator address
...
export declare const SlashingApiFactory: (configuration?: Configuration | undefined, basePath?: string | undefined, axios?: AxiosInstance | undefined) => {
     ...
     * @throws {RequiredError}
     */
    slashingSigningInfosGet(page: number, limit: number, options?: any): AxiosPromise<Array<SigningInfo>>;
    /**
     * Send transaction to unjail a jailed validator
     * @summary Unjail a jailed validator
     * @param {string} validatorAddr Bech32 validator address
...
export declare const StakingApiFp: (configuration?: Configuration | undefined) => {
     ...
     * @throws {RequiredError}
     */
    stakingDelegatorsDelegatorAddrDelegationsGet(delegatorAddr: string, options?: any): (axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<Array<Delegation>>;
    /**
     *
     * @summary Submit delegation
     * @param {string} delegatorAddr Bech32 AccAddress of Delegator
     ...
     * @throws {RequiredError}
     */
    stakingDelegatorsDelegatorAddrUnbondingDelegationsGet(delegatorAddr: string, options?: any): (axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<Array<UnbondingDelegation>>;
    /**
     *
     * @summary Submit an unbonding delegation
     * @param {string} delegatorAddr Bech32 AccAddress of Delegator
     ...
     * @throws {RequiredError}
     */
    stakingDelegatorsDelegatorAddrValidatorsGet(delegatorAddr: string, options?: any): (axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<Array<Validator>>;
    /**
     *
     * @summary Query a validator that a delegator is bonded to
     * @param {string} delegatorAddr Bech32 AccAddress of Delegator
     ...
     * @throws {RequiredError}
     */
    stakingRedelegationsGet(delegator?: string | undefined, validatorFrom?: string | undefined, validatorTo?: string | undefined, options?: any): (axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<Array<Redelegation>>;
    /**
     *
     * @summary Get all validator candidates. By default it returns only the bonded validators.
     * @param {string} [status] The validator bond status. Must be either \&#39;bonded\&#39;, \&#39;unbonded\&#39;, or \&#39;unbonding\&#39;.
     ...
     * @throws {RequiredError}
     */
    stakingValidatorsGet(status?: string | undefined, page?: number | undefined, limit?: number | undefined, options?: any): (axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<Array<Validator>>;
    /**
     *
     * @summary Get all delegations from a validator
     * @param {string} validatorAddr Bech32 OperatorAddress of validator
     ...
     * @throws {RequiredError}
     */
    stakingValidatorsValidatorAddrDelegationsGet(validatorAddr: string, options?: any): (axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<Array<Delegation>>;
    /**
     *
     * @summary Query the information from a single validator
     * @param {string} validatorAddr Bech32 OperatorAddress of validator
     ...
     * @throws {RequiredError}
     */
    stakingValidatorsValidatorAddrUnbondingDelegationsGet(validatorAddr: string, options?: any): (axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<Array<UnbondingDelegation>>;
};
/**
...
export declare const StakingApiFactory: (configuration?: Configuration | undefined, basePath?: string | undefined, axios?: AxiosInstance | undefined) => {
     ...
     * @throws {RequiredError}
     */
    stakingDelegatorsDelegatorAddrDelegationsGet(delegatorAddr: string, options?: any): AxiosPromise<Array<Delegation>>;
    /**
     *
     * @summary Submit delegation
     * @param {string} delegatorAddr Bech32 AccAddress of Delegator
     ...
     * @throws {RequiredError}
     */
    stakingDelegatorsDelegatorAddrUnbondingDelegationsGet(delegatorAddr: string, options?: any): AxiosPromise<Array<UnbondingDelegation>>;
    /**
     *
     * @summary Submit an unbonding delegation
     * @param {string} delegatorAddr Bech32 AccAddress of Delegator
     ...
     * @throws {RequiredError}
     */
    stakingDelegatorsDelegatorAddrValidatorsGet(delegatorAddr: string, options?: any): AxiosPromise<Array<Validator>>;
    /**
     *
     * @summary Query a validator that a delegator is bonded to
     * @param {string} delegatorAddr Bech32 AccAddress of Delegator
     ...
     * @throws {RequiredError}
     */
    stakingValidatorsGet(status?: string | undefined, page?: number | undefined, limit?: number | undefined, options?: any): AxiosPromise<Array<Validator>>;
    /**
     *
     * @summary Get all delegations from a validator
     * @param {string} validatorAddr Bech32 OperatorAddress of validator
     ...
     * @throws {RequiredError}
     */
    stakingValidatorsValidatorAddrDelegationsGet(validatorAddr: string, options?: any): AxiosPromise<Array<Delegation>>;
    /**
     *
     * @summary Query the information from a single validator
     * @param {string} validatorAddr Bech32 OperatorAddress of validator
     ...
     * @throws {RequiredError}
     */
    stakingValidatorsValidatorAddrUnbondingDelegationsGet(validatorAddr: string, options?: any): AxiosPromise<Array<UnbondingDelegation>>;
};
/**
