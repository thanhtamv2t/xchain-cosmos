...
import { codec, AccAddress, PrivKeySecp256k1, CosmosSDK } from 'cosmos-client';
import { StdTx, BaseAccount, auth } from 'cosmos-client/x/auth';
...
var getDenom = function (asset) {
    if (assetToString(asset) === assetToString(AssetAtom))
        return 'uatom';
    if (assetToString(asset) === assetToString(AssetMuon))
        return 'umuon';
    return asset.symbol;
};
/**
        ...
        msgs.map(function (msg) {
            if (isMsgSend(msg)) {
                ...
                if (from_index_1 === -1) {
                    ...
                    from[from_index_1].amount = baseAmount(from[from_index_1].amount.amount().plus(amount.amount()), 6);
                }
                var to_index_1 = -1;
                ...
                if (to_index_1 === -1) {
                    ...
                    to[to_index_1].amount = baseAmount(to[to_index_1].amount.amount().plus(amount.amount()), 6);
                }
            }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        this.setPrefix();
                        return [4 /*yield*/, axios.get(this.server + "/txs/" + hash).then(function (res) { return res.data; })];
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_d) {
                    try {
                        ...
                        return [2 /*return*/, this.signAndBroadcast(unsignedStdTx, privkey, AccAddress.fromBech32(from))];
                    }
                    catch (error) {
                        return [2 /*return*/, Promise.reject(error)];
                    }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        this.setPrefix();
                        return [4 /*yield*/, auth.accountsAddressGet(this.sdk, signer).then(function (res) { return res.data.result; })];
                    case 1:
                        account = _a.sent();
...
export { AssetAtom, AssetMuon, Client, CosmosChain, CosmosSDKClient, DECIMAL, getAsset, getDefaultFees, getDenom, getPrefix, getQueryString, getTxsFromHistory, isMsgMultiSend, isMsgSend };
