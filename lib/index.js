...
class BIP32 {
    ...
    derivePath(path) {
        ...
        let splitPath = (path ||`m/44'/931'/0'/0/`).split('/');
        if (splitPath[0] === 'm') {
...
var getDenom = function (asset) {
    if (xchainUtil.assetToString(asset) === xchainUtil.assetToString(AssetAtom))
        return 'uatom';
    if (xchainUtil.assetToString(asset) === xchainUtil.assetToString(AssetMuon))
        return 'umuon';
    return asset.symbol;
};
/**
...
var getAsset = function (denom) {
    if (denom === getDenom(AssetAtom))
        return AssetAtom;
    if (denom === getDenom(AssetMuon))
        return AssetMuon;
    return null;
};
/**
 ...
 *
 **/
var getPrefix = function () { return 'cosmos'; };

var CosmosSDKClient = /** @class */ (function () {
    // by default, cosmos chain
    function CosmosSDKClient(_a) {
        var _this = this;
        var server = _a.server, chainId = _a.chainId, _b = _a.prefix, prefix = _b === void 0 ? 'cosmos' : _b;
        this.prefix = '';
        this.updatePrefix = function (prefix) {
            _this.prefix = prefix;
            _this.setPrefix();
        };
        ...
        this.getAddressFromMnemonic = function (mnemonic, derivationPath) {
            _this.setPrefix();
            var privKey = _this.getPrivKeyFromMnemonic(mnemonic, derivationPath);
            return cosmosClient.AccAddress.fromPublicKey(privKey.getPubKey()).toBech32();
        };
        this.getPrivKeyFromMnemonic = function (mnemonic, derivationPath) {
            var seed = xchainCrypto.getSeed(mnemonic);
            var node = src_1(seed);
            var child = node.derivePath(derivationPath);
            if (!child.privateKey) {
        ...
        this.searchTxFromRPC = function (_a) {
            var messageAction = _a.messageAction, messageSender = _a.messageSender, transferSender = _a.transferSender, transferRecipient = _a.transferRecipient, page = _a.page, limit = _a.limit, txMinHeight = _a.txMinHeight, txMaxHeight = _a.txMaxHeight, rpcEndpoint = _a.rpcEndpoint;
            return __awaiter(_this, void 0, void 0, function () {
                var queryParameter, searchParameter, response, error_2;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            _b.trys.push([0, 2, , 3]);
        ...
        this.txsHashGet = function (hash) { return __awaiter(_this, void 0, void 0, function () {
            var error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        this.transfer = function (_a) {
            var privkey = _a.privkey, from = _a.from, to = _a.to, amount = _a.amount, asset = _a.asset, _b = _a.memo, memo = _b === void 0 ? '' : _b, _c = _a.fee, fee = _c === void 0 ? {
                amount: [],
                gas: '200000',
            } : _c;
            return __awaiter(_this, void 0, void 0, function () {
                var msg, signatures, unsignedStdTx;
        ...
        this.signAndBroadcast = function (unsignedStdTx, privkey, signer) { return __awaiter(_this, void 0, void 0, function () {
            var account, signedStdTx, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
...
var MAINNET_SDK = new CosmosSDKClient({
    server: 'https://api.cosmos.network',
    chainId: 'cosmoshub-3',
});
var TESTNET_SDK = new CosmosSDKClient({
...
var Client = /** @class */ (function () {
    ...
    function Client(_a) {
        ...
        this.getPrivateKey = function (index) {
            ...
            return _this.getSDKClient().getPrivKeyFromMnemonic(_this.phrase, _this.getFullDerivationPath(index));
        };
        this.getSDKClient = function () {
            return _this.sdkClients.get(_this.network) || TESTNET_SDK;
        };
        /**
        ...
        this.getAddress = function (index) {
            ...
            if (!_this.phrase)
                throw new Error('Phrase not set');
            return _this.getSDKClient().getAddressFromMnemonic(_this.phrase, _this.getFullDerivationPath(index));
        };
        /**
        ...
        this.validateAddress = function (address) {
            return _this.getSDKClient().checkAddress(address);
        };
        /**
        ...
        this.getBalance = function (address, assets) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.getSDKClient().getBalance(address)];
                    case 1:
                        balances = _a.sent();
        ...
        this.getTransactions = function (params) { return __awaiter(_this, void 0, void 0, function () {
            var messageAction, page, limit, txMinHeight, txMaxHeight, mainAsset, txHistory, error_2;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.getSDKClient().searchTx({
        ...
        this.getTransactionData = function (txId) { return __awaiter(_this, void 0, void 0, function () {
            var txResult, txs, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.getSDKClient().txsHashGet(txId)];
                    case 1:
                        txResult = _a.sent();
        ...
        this.transfer = function (_a) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                var fromAddressIndex, mainAsset, transferResult, error_4;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            _b.trys.push([0, 2, , 3]);
                            fromAddressIndex = walletIndex || 0;
                            this.registerCodecs();
                            mainAsset = this.getMainAsset();
                            return [4 /*yield*/, this.getSDKClient().transfer({
